...
class WindowMSA(BaseModule):
    ...
    def __init__(self,
        ...
        self.lora_rank = 64
        self.qkv = MergedLinear(embed_dims, 3 * embed_dims, r=self.lora_rank, enable_lora=[True, False, True])
        if qkv_bias:
...
class RingMoLora(BaseModule):
    ...
    def __init__(self,
        ...
        super(RingMoLora, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(RingMoLora, self).train(mode)
        self._freeze_stages()
        self._mark_lora_trainable_params()

    def _mark_lora_trainable_params(self):
