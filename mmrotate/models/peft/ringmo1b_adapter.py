...
class Adapter(nn.Module):
    def __init__(self, c_in, reduction=96):
...
class SwinBlock(BaseModule):
    ...
    def __init__(self,
        ...
        self.topN = 96
        self.adapter_module1 = Adapter(embed_dims, embed_dims//self.topN)
        self.adapter_module2 = Adapter(embed_dims, embed_dims//self.topN)
    ...
    def forward(self, x, hw_shape):
        ...
        def _inner_forward(x):
            ...
            x = self.adapter_module1(x)
            # print('5'*30, x)

            ### FFN 
            # print('6'*30, x)
            #x = x + self.drop_path(self.norm2(self.mlp(x)))
            x = x + self.adapter_module2(self.drop_path(self.norm2(self.mlp(x))))
...
class RingMoAdapter(BaseModule):
    """ Swin Transformer
    ...
    def __init__(self,
        ...
        super(RingMoAdapter, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(RingMoAdapter, self).train(mode)
        self._freeze_stages()
        self._mark_adapter_trainable_params()

    def _mark_adapter_trainable_params(self):
