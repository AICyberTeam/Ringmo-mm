...
class MixedDataset(CustomDataset):
    ...
    """
    # CLASSES = [ 'other-ship','other-airplane', 'Boeing737','Boeing777', 'Boeing787','Boeing747', 'A220', 'A321','A350','Passenger Ship','Engineering Ship',
    #             'Dry Cargo Ship','Tugboat','Volleyball Court','Motorboat','Bridge','Sewage Treatment Plant','Oil Tank','Liquid Cargo Ship',
    #             'Fishing Boat','Basketball Court',   'Tennis Court','Badminton Court','Football Field', 'Outdoor Stadium','Warship'
    #            ]
    CLASSES = ['其他舰船', '其他飞机', '波音737', '波音777', '波音787', '波音747', '空客A220', '空客A321',
               '空客A350', '客运船', '工程船',
               '干货船', '拖船', '排球场', '摩托艇', '桥梁', '污水处理厂',
               '油罐', '液货船',
               '渔船', '篮球场', '网球场', '羽毛球场', '足球场',
               '露天体育场', '军舰'
               ]
    ...
    def __init__(self,
        ...
        super(MixedDataset, self).__init__(ann_file, pipeline, **kwargs)
    ...
    def load_annotations(self, ann_folder):
        ...
        if not ann_files:  # test phase
            ...
            for ann_file in ann_files:
                ...
                img_name = image_name or img_id + "." + self.image_suffix
                data_info['filename'] = img_name
    ...
    def _filter_imgs(self, **kwargs):
        ...
        for i, data_info in enumerate(self.data_infos):
            ...
            if (not self.filter_empty_gt
                ...
                valid_inds.append(i)
        return valid_inds
    def _filter_small(self,data_info):
        data_area = data_info['ann']['bboxes'][2] * data_info['ann']['bboxes'][3]
        print(data_area, data_area['ann']['labels'])
        if data_area < self.min_area:
            return True
