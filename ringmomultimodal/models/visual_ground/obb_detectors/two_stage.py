...
class MultiModalTwoStageOBBDetectorBase(RotatedTwoStageDetector):
    def __init__(self,
                 multimodal_backbone,
                 rpn_head,
                 roi_head,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(MultiModalTwoStageOBBDetectorBase, self).__init__(
            backbone=multimodal_backbone['backbone_left'],
            neck=neck,
            rpn_head=rpn_head,
            roi_head=roi_head,
            train_cfg=train_cfg,
