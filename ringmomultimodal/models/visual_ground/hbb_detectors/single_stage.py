...
from ...builder import build_multimodal
from mmcv.runner import auto_fp16
from debug_tools import show_value
import torch


class MultiModalSingleStageHBBDetectorBase(SingleStageDetector, ABC):
    def __init__(self,
                 multimodal_backbone,
                 neck=None,
                 bbox_head=None,
        ...
        super().__init__(
            backbone=dict(type='IdentityBackbone'),
            neck=neck,
            bbox_head=bbox_head,
            train_cfg=train_cfg,
            test_cfg=test_cfg,
    ...
    def train_step(self, data, optimizer):
        ...
        outputs = dict(
            loss=loss, log_vars=log_vars, num_samples=len(data['appendix']['img_metas']))
    ...
    def val_step(self, data, optimizer=None):
        ...
        outputs = dict(
            loss=loss, log_vars=log_vars_, num_samples=len(data['appendix']['img_metas']))
