...
from ...builder import BBOX_HEAD, build_loss


@BBOX_HEAD.register_module()
class VGYOLOV3Head(YOLOV3Head):
    """
    Args:
    ...
    def get_bboxes(self,
        ...
        for (bboxes, objectness) in zip(flatten_bboxes,
                                        flatten_objectness):
            det_results.append(bboxes[torch.argmax(objectness)])
        return det_results
    ...
    def loss(self,
        ...
        target_maps_list, neg_maps_list = self.get_targets(
            anchor_list, responsible_flag_list, gt_bboxes)
    ...
    def get_targets(self, anchor_list, responsible_flag_list, gt_bboxes_list, **kwargs):
    ...
    def _get_targets_single(self, anchors, responsible_flags, gt_bboxes, **kwargs):
