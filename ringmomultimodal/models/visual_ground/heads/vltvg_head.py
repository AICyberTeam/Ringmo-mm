...
from mmdet.core import (bbox_cxcywh_to_xyxy, bbox_xyxy_to_cxcywh,
                        ...
                        reduce_mean)
from ringmomultimodal.models.visual_ground.losses import GIoU_Loss, reg_loss
import torch
from mmcv.runner import force_fp32
from ringmomultimodal.models.builder import BBOX_HEAD
import torch.nn.functional as F
from mmdet.models.losses import GIoULoss, SmoothL1Loss
from mmdet.models.builder import build_loss
from debug_tools import show_value

@BBOX_HEAD.register_module()
class VLTVGHead(BaseDenseHead):
    def __init__(self,
                 hidden_dim,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(VLTVGHead, self).__init__(init_cfg)
        self.predict_head = MLP(hidden_dim, hidden_dim, 4, 3)
