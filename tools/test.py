...
from mmcv.runner import (get_dist_info, init_dist, load_checkpoint,
                         wrap_fp16_model)
from ringmomultimodal.apis import multi_gpu_test, single_gpu_test
from mmdet.datasets import build_dataloader, replace_ImageToTensor

from ringmomultimodal.datasets import build_dataset
from ringmomultimodal.models import build_multimodal_detector
from ringmomultimodal.utils import (build_ddp, build_dp, compat_cfg, get_device,
...
def main():
    ...
    model = build_multimodal_detector(cfg.model, test_cfg=cfg.get('test_cfg'))
